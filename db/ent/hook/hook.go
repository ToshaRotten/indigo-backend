...
// The TypeOfPackagingFunc type is an adapter to allow the use of ordinary
// function as TypeOfPackaging mutator.
type TypeOfPackagingFunc func(context.Context, *ent.TypeOfPackagingMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TypeOfPackagingFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TypeOfPackagingMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TypeOfPackagingMutation", m)
}
...
// The UserCategoryFunc type is an adapter to allow the use of ordinary
// function as UserCategory mutator.
type UserCategoryFunc func(context.Context, *ent.UserCategoryMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UserCategoryFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UserCategoryMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UserCategoryMutation", m)
}
