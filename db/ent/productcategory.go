...
type ProductCategoryEdges struct {
	...
	Category []*Product `json:"category,omitempty"`
...
func (e ProductCategoryEdges) CategoryOrErr() ([]*Product, error) {
	if e.loadedTypes[0] {
...
func (pc *ProductCategory) QueryCategory() *ProductQuery {
	return NewProductCategoryClient(pc.config).QueryCategory(pc)
}
