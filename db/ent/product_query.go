...
type ProductQuery struct {
	...
	withOrderDetailProduct     *OrderDetailQuery
	withShoppingCartProduct    *ShoppingCartQuery
	withProductPriceProduct    *ProductPriceQuery
	withProductCategory        *ProductCategoryQuery
	withTypeOfPackagingProduct *TypeOfPackagingQuery
...
// QueryOrderDetailProduct chains the current query on the "order_detail_product" edge.
func (pq *ProductQuery) QueryOrderDetailProduct() *OrderDetailQuery {
...
// QueryShoppingCartProduct chains the current query on the "shopping_cart_product" edge.
func (pq *ProductQuery) QueryShoppingCartProduct() *ShoppingCartQuery {
	query := (&ShoppingCartClient{config: pq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := pq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryProductPriceProduct chains the current query on the "product_price_product" edge.
func (pq *ProductQuery) QueryProductPriceProduct() *ProductPriceQuery {
	query := (&ProductPriceClient{config: pq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := pq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryTypeOfPackagingProduct chains the current query on the "type_of_packaging_product" edge.
func (pq *ProductQuery) QueryTypeOfPackagingProduct() *TypeOfPackagingQuery {
	query := (&TypeOfPackagingClient{config: pq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := pq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (pq *ProductQuery) Clone() *ProductQuery {
	...
	return &ProductQuery{
		...
		withOrderDetailProduct:     pq.withOrderDetailProduct.Clone(),
		withShoppingCartProduct:    pq.withShoppingCartProduct.Clone(),
		withProductPriceProduct:    pq.withProductPriceProduct.Clone(),
		withProductCategory:        pq.withProductCategory.Clone(),
		withTypeOfPackagingProduct: pq.withTypeOfPackagingProduct.Clone(),
...
// WithOrderDetailProduct tells the query-builder to eager-load the nodes that are connected to
// the "order_detail_product" edge. The optional arguments are used to configure the query builder of the edge.
func (pq *ProductQuery) WithOrderDetailProduct(opts ...func(*OrderDetailQuery)) *ProductQuery {
	query := (&OrderDetailClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	pq.withOrderDetailProduct = query
	return pq
}

// WithShoppingCartProduct tells the query-builder to eager-load the nodes that are connected to
// the "shopping_cart_product" edge. The optional arguments are used to configure the query builder of the edge.
func (pq *ProductQuery) WithShoppingCartProduct(opts ...func(*ShoppingCartQuery)) *ProductQuery {
	query := (&ShoppingCartClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	pq.withShoppingCartProduct = query
	return pq
}

// WithProductPriceProduct tells the query-builder to eager-load the nodes that are connected to
// the "product_price_product" edge. The optional arguments are used to configure the query builder of the edge.
func (pq *ProductQuery) WithProductPriceProduct(opts ...func(*ProductPriceQuery)) *ProductQuery {
	query := (&ProductPriceClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	pq.withProductPriceProduct = query
	return pq
}
...
// WithTypeOfPackagingProduct tells the query-builder to eager-load the nodes that are connected to
// the "type_of_packaging_product" edge. The optional arguments are used to configure the query builder of the edge.
func (pq *ProductQuery) WithTypeOfPackagingProduct(opts ...func(*TypeOfPackagingQuery)) *ProductQuery {
	query := (&TypeOfPackagingClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	pq.withTypeOfPackagingProduct = query
	return pq
}
...
func (pq *ProductQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Product, error) {
	var (
		...
		_spec       = pq.querySpec()
		loadedTypes = [5]bool{
			pq.withOrderDetailProduct != nil,
			pq.withShoppingCartProduct != nil,
			pq.withProductPriceProduct != nil,
			pq.withProductCategory != nil,
			pq.withTypeOfPackagingProduct != nil,
		}
	)
	...
	if query := pq.withOrderDetailProduct; query != nil {
		if err := pq.loadOrderDetailProduct(ctx, query, nodes,
			func(n *Product) { n.Edges.OrderDetailProduct = []*OrderDetail{} },
			func(n *Product, e *OrderDetail) { n.Edges.OrderDetailProduct = append(n.Edges.OrderDetailProduct, e) }); err != nil {
			return nil, err
		}
	}
	if query := pq.withShoppingCartProduct; query != nil {
		if err := pq.loadShoppingCartProduct(ctx, query, nodes,
			func(n *Product) { n.Edges.ShoppingCartProduct = []*ShoppingCart{} },
			func(n *Product, e *ShoppingCart) {
				n.Edges.ShoppingCartProduct = append(n.Edges.ShoppingCartProduct, e)
			}); err != nil {
			return nil, err
		}
	}
	if query := pq.withProductPriceProduct; query != nil {
		if err := pq.loadProductPriceProduct(ctx, query, nodes,
			func(n *Product) { n.Edges.ProductPriceProduct = []*ProductPrice{} },
			func(n *Product, e *ProductPrice) {
				n.Edges.ProductPriceProduct = append(n.Edges.ProductPriceProduct, e)
			}); err != nil {
			return nil, err
		}
	}
	if query := pq.withProductCategory; query != nil {
		if err := pq.loadProductCategory(ctx, query, nodes, nil,
			func(n *Product, e *ProductCategory) { n.Edges.ProductCategory = e }); err != nil {
			return nil, err
		}
	}
	if query := pq.withTypeOfPackagingProduct; query != nil {
		if err := pq.loadTypeOfPackagingProduct(ctx, query, nodes, nil,
			func(n *Product, e *TypeOfPackaging) { n.Edges.TypeOfPackagingProduct = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (pq *ProductQuery) loadOrderDetailProduct(ctx context.Context, query *OrderDetailQuery, nodes []*Product, init func(*Product), assign func(*Product, *OrderDetail)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(orderdetail.FieldOrderID)
	}
	query.Where(predicate.OrderDetail(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(product.OrderDetailProductColumn), fks...))
	}))
...
func (pq *ProductQuery) loadShoppingCartProduct(ctx context.Context, query *ShoppingCartQuery, nodes []*Product, init func(*Product), assign func(*Product, *ShoppingCart)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Product)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(shoppingcart.FieldProductID)
	}
	query.Where(predicate.ShoppingCart(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(product.ShoppingCartProductColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (pq *ProductQuery) loadProductPriceProduct(ctx context.Context, query *ProductPriceQuery, nodes []*Product, init func(*Product), assign func(*Product, *ProductPrice)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Product)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(productprice.FieldProductID)
	}
	query.Where(predicate.ProductPrice(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(product.ProductPriceProductColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (pq *ProductQuery) loadTypeOfPackagingProduct(ctx context.Context, query *TypeOfPackagingQuery, nodes []*Product, init func(*Product), assign func(*Product, *TypeOfPackaging)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Product)
	for i := range nodes {
		fk := nodes[i].TypeOfPackagingID
		if _, ok := nodeids[fk]; !ok {
			ids = append(ids, fk)
		}
		nodeids[fk] = append(nodeids[fk], nodes[i])
	...
	query.Where(typeofpackaging.IDIn(ids...))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	}
	for _, n := range neighbors {
		nodes, ok := nodeids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "type_of_packaging_id" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (pq *ProductQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := pq.ctx.Fields; len(fields) > 0 {
		...
		if pq.withProductCategory != nil {
			_spec.Node.AddColumnOnce(product.FieldProductCategoryID)
		}
		if pq.withTypeOfPackagingProduct != nil {
			_spec.Node.AddColumnOnce(product.FieldTypeOfPackagingID)
		}
	}
