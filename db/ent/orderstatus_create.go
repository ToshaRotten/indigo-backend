...
func (osc *OrderStatusCreate) SetName(s string) *OrderStatusCreate {
	osc.mutation.SetName(s)
	return osc
}

// SetNillableName sets the "name" field if the given value is not nil.
func (osc *OrderStatusCreate) SetNillableName(s *string) *OrderStatusCreate {
	if s != nil {
		osc.SetName(*s)
	}
	return osc
...
func (osc *OrderStatusCreate) AddStatuIDs(ids ...int) *OrderStatusCreate {
	osc.mutation.AddStatuIDs(ids...)
	return osc
}

// AddStatus adds the "status" edges to the Order entity.
func (osc *OrderStatusCreate) AddStatus(o ...*Order) *OrderStatusCreate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return osc.AddStatuIDs(ids...)
}
...
func (osc *OrderStatusCreate) createSpec() (*OrderStatus, *sqlgraph.CreateSpec) {
	...
	if nodes := osc.mutation.StatusIDs(); len(nodes) > 0 {
