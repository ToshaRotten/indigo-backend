...
func NameIsNil() predicate.ProductCategory {
	return predicate.ProductCategory(sql.FieldIsNull(FieldName))
}

// NameNotNil applies the NotNil predicate on the "name" field.
func NameNotNil() predicate.ProductCategory {
	return predicate.ProductCategory(sql.FieldNotNull(FieldName))
}
...
func HasCategoryWith(preds ...predicate.Product) predicate.ProductCategory {
	return predicate.ProductCategory(func(s *sql.Selector) {
